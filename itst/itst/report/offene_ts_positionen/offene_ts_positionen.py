    ...
    for p in projects:
        ...
        sql_query = """
            SELECT 
                ...
                `tabTimesheet Detail`.`billing_amount` AS `billing_amount`, 
                `tabTimesheet Detail`.`costing_amount` AS `costing_amount`, 
                `tabTimesheet Detail`.`from_time` AS `oldest`,
                `tabTimesheet Detail`.`to_time` AS `newest`,
                `tabCustomer`.`customer_name` AS `customer_name`,
